        ...
        <div className="sticky top-0 z-10">
            ...
            <div className={nav ? "fixed left-0 top-0 w-[60%] border-r border-r-blue-600 h-full bg-white ease-in-out duration-500" : "fixed left-[-100%]"}>
                ...
                <ul className="pt-12 uppercase">
                    <li className="p-4 border-b border-b-blue-600"><a href="#home">Home</a></li>
                    <li className="p-4 border-b border-b-blue-600"><a href="#company">Company</a></li>
                    <li className="p-4 border-b border-b-blue-600"><a href="#services">Services</a></li>
                    <li className="p-4 border-b border-b-blue-600"><a href="#price">Price</a></li>
                    <li className="p-4 border-b border-b-blue-600"><a href="#contact">Contact</a></li>
                </ul>
            </div>
        </div>
    );
